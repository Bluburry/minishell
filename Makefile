...
#    Updated: 2023/10/20 17:38:58 by jecarval         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_ROOT	=	minishell
PARSING		=	parser parser_utils split_tokens split_quote_tokens split_char_tokens \
				split_inout_tokens split_space_tokens split_tokens_cleanup
